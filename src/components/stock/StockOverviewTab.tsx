  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <MetricCard label="Market Capitalization" value={`Rs. ${(quote.marketCap / 100).toFixed(2)} Arb`} subValue={`Rank #1 in ${quote.sector}`} highlight />
        <MetricCard label="P/E Multiple" value={`${fundamentals.valuation.pe}x`} subValue={`Sector Median: 22.4x`} />
        ...
        <MetricCard label="Delivery Volume %" value={`${quote.deliveryPercentage}%`} subValue="Positional Absorption" />
